...
var CometChatMessages = function CometChatMessages(props) {
  ...
  var messagesManager = _react.default.useRef(new _controller.MessagesManager());
  ...
  var getReceivedMessageInputData = function getReceivedMessageInputData() {
    if (user) {
      ...
      var timestamp = (_messageListConfiguration === null || _messageListConfiguration === void 0 ? void 0 : (_messageListConfigura9 = _messageListConfiguration.receivedMessageInputData) === null || _messageListConfigura9 === void 0 ? void 0 : _messageListConfigura9.timestamp) || true,
      ...
      var _timestamp2 = (_messageListConfiguration === null || _messageListConfiguration === void 0 ? void 0 : (_messageListConfigura13 = _messageListConfiguration.receivedMessageInputData) === null || _messageListConfigura13 === void 0 ? void 0 : _messageListConfigura13.timestamp) || true,
        _readReceipt2 = (_messageListConfiguration === null || _messageListConfiguration === void 0 ? void 0 : (_messageListConfigura14 = _messageListConfiguration.receivedMessageInputData) === null || _messageListConfigura14 === void 0 ? void 0 : _messageListConfigura14.readReceipt) || false,
        _thumbnail2 = (_messageListConfiguration === null || _messageListConfiguration === void 0 ? void 0 : (_messageListConfigura15 = _messageListConfiguration.receivedMessageInputData) === null || _messageListConfigura15 === void 0 ? void 0 : _messageListConfigura15.thumbnail) || true,
        _title2 = (_messageListConfiguration === null || _messageListConfiguration === void 0 ? void 0 : (_messageListConfigura16 = _messageListConfiguration.receivedMessageInputData) === null || _messageListConfigura16 === void 0 ? void 0 : _messageListConfigura16.title) || true;
      return new _2.MessageInputData({
  ...
  var onTransientMessageReceived = function onTransientMessageReceived(message) {
    if (message.data.type === _2.MetadataConstants.liveReaction) {
      ...
      var payload = {
        ...
        style: new _.LiveReactionStyles((0, _style.liveReactionStyle)() || {})
      };
  ...
  var _messageTypes = messageTypes || messageComposerConfig.messageTypes;
  var _customOutgoingMessageSound = customOutgoingMessageSound || messageComposerConfig.customOutgoingMessageSound;
  var _enableSoundForMessages = enableSoundForMessages || messageComposerConfig.enableSoundForMessages;
  var _excludeMessageTypes = messageComposerConfig.excludeMessageTypes;
  var _enableTypingIndicator = enableTypingIndicator || messageComposerConfig.enableTypingIndicator;
  ...
  var _enableIndicator = enableTypingIndicator || messageHeaderConfig.enableTypingIndicator;
  ...
  (0, _hooks.Hooks)(props, loggedInUser, errorHandler, messagesCallback, messagesManager);
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    group: group,
    theme: _theme,
    style: (0, _style.messageHeaderStyle)(_theme, messageHeaderConfig),
    ...
    emptyText: (0, _2.localize)("NO_MESSAGES_FOUND"),
    errorText: (0, _2.localize)("SOMETHING_WRONG"),
    ...
    style: (0, _style.messageListStyle)(_theme, _messageListConfiguration),
    ...
    theme: _theme
  }), liveReactionView, !hideMessageComposer ? /*#__PURE__*/_react.default.createElement(_.CometChatMessageComposer, {
    ...
    theme: _theme,
    style: (0, _style.messageComposerStyle)(_theme, messageComposerConfig)
  }) : null);
};
