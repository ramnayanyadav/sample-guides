  ...
  _react.default.useEffect(function () {
    ...
    if (props.messageTypes && props.messageTypes.length) {
      ...
      actionItems = Items.filter(function (item, index) {
        if (item.type !== _.MessageTypeConstants.text && item.type !== _.MessageTypeConstants.sticker) {
          return item;
        }
      });
      ...
      var _Items = defaultTypes.map(function (item, index) {
        if (item.onActionClick === null) {
          return helper(item.type, item);
        }
      ...
      actionItems = _Items === null || _Items === void 0 ? void 0 : _Items.filter(function (item, index) {
